// Templates HTML pour les emails NiouDem Drive
...
function header() {
  return `
    <div style="text-align: center; margin-bottom: 32px;">
      <span style="font-size: 22px; font-weight: 900; color: #00F5A0;">NiouDem</span>
...
function footer() {
  return `
    <div style="text-align: center; margin-top: 32px; padding-top: 24px; border-top: 1px solid #1f2937;">
      <p style="${mutedStyle}">NiouDem Drive · Île-de-France · <a href="https://nioudem-drive.onrender.com" style="color: #00F5A0; text-decoration: none;">nioudem-drive.onrender.com</a></p>
    ...
    <body style="${baseStyle}">
      <div style="${containerStyle}">
        ...
        <div style="text-align: center;">
          <a href="https://nioudem-drive.onrender.com/dashboard/eleve" style="${btnStyle}">Voir mes réservations →</a>
        </div>
        ${footer()}
      </div>
    </body>
  ...
  return `
    ...
    <body style="${baseStyle}">
      <div style="${containerStyle}">
        ...
        <div style="text-align: center;">
          <a href="https://nioudem-drive.onrender.com/dashboard/moniteur" style="${btnStyle}">Répondre à la demande →</a>
        </div>
        ${footer()}
      </div>
    </body>
  ...
  return `
    ...
    <body style="${baseStyle}">
      <div style="${containerStyle}">
        ...
        <div style="text-align: center;">
          <a href="https://nioudem-drive.onrender.com/dashboard/eleve" style="${btnStyle}">Voir ma leçon →</a>
        </div>
        ${footer()}
      </div>
    </body>
