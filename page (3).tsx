...
.animate-swing::before {
  ...
  width: 2px;
  height: 60px;
  background: linear-gradient(to bottom, rgba(0, 245, 160, 0.6), rgba(0, 212, 255, 0.3), transparent);
  transform-origin: top center;
  animation: thread 2.5s ease-in-out infinite;
}
