  ...
  return (
    <div className="font-sans text-foreground overflow-x-hidden min-h-screen">
      ...
      <section className="pt-32 pb-20 px-4 relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            NiouDem Drive est né d'un constat simple : apprendre à conduire en France est encore trop souvent synonyme de frustration, d'opacité et de manque de choix. On pense qu'on peut faire mieux.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-3xl mx-auto px-4 pb-24 flex flex-col gap-16">
        ...
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed mb-6">
            NiouDem Drive part d'une conviction : <strong className="text-foreground">le bon moniteur change tout.</strong> Un enseignant qui correspond à votre rythme, vos créneaux, votre niveau d'anxiété et vos objectifs — c'est la différence entre décrocher son permis du premier coup ou accumuler les échecs et les dépenses.
          </p>
          <p className="text-muted-foreground leading-relaxed mb-6">
          ...
          <div className="bg-gradient-to-r from-[#00F5A0]/8 to-[#00D4FF]/8 border border-border rounded-2xl p-6">
            <p className="text-base font-semibold text-center leading-relaxed">
              "Dans dix ans, choisir son enseignant de conduite sera aussi naturel que choisir son médecin. NiouDem Drive construit cette normalité."
            </p>
          </div>
        </section>
      ...
      <footer className="border-t border-border px-4 md:px-8 py-8 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <p className="text-muted-foreground text-xs">© 2025 NiouDem Drive · Île-de-France · Tous droits réservés</p>
